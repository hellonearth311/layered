...
urlpatterns = [
    ...
    path("root/print/rewards/", print_rewards, name="print_rewards"),
    path("root/print/rewards/grant_all/", grant_all_print_rewards, name="grant_all_print_rewards"),
    path("root/print/rewards/<int:user_id>/grant/", grant_print_reward, name="grant_print_reward"),
